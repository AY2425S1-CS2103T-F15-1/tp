...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Nurse requests to edit the patient details of a specific patient.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare edits the details of the specified person in the list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Initial launch")]),_v(" "),_c('ol',[_c('li',[_v("Download the jar file and copy into an empty folder.")]),_v(" "),_c('li',[_v("Open a terminal and navigate to the folder containing the jar file.")]),_v(" "),_c('li',[_v("Run the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java -jar NovaCare.jar")]),_c('br'),_v("Expected: The app launches with a set of sample patients. The window size may not be optimal.")])])]),_v(" "),_c('li',[_c('p',[_v("Saving window preferences")]),_v(" "),_c('ol',[_c('li',[_v("Resize the window to an optimum size. Move the window to a different location. Close the window.")]),_v(" "),_c('li',[_v("Re-launch the app by running the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java -jar NovaCare.jar")]),_v("."),_c('br'),_v("Expected: The most recent window size and location is retained.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Deleting a patient while all patients are being shown")]),_v(" "),_c('ol',[_c('li',[_v("Prerequisites: List all patients using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple patients in the list.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 1")]),_c('br'),_v("Expected: First contact is deleted from the list. Details of the deleted patient shown in the status message. Timestamp in the status bar is updated.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 0")]),_c('br'),_v("Expected: No patient is deleted. Error details shown in the status message. Status bar remains the same.")]),_v(" "),_c('li',[_v("Other incorrect delete commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete x")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (where x is larger than the list size)"),_c('br'),_v("Expected: Similar to previous.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Adding a task to a patient while all patients are being shown")]),_v(" "),_c('ol',[_c('li',[_v("Prerequisites: Patient should already exist in the list.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addtask 1 d/Eat Medication")]),_c('br'),_v("Expected: Task \"Eat Medication\" is added to the task list for the patient with ID 1. Details of the added task are shown in the status message. Timestamp in the status bar is updated.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addtask 0 d/Eat Medication")]),_c('br'),_v("Expected: No task is added. Error details are shown in the status message indicating an invalid patient ID. Status bar remains the same.")]),_v(" "),_c('li',[_v("Other incorrect add task commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addtask")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addtask x d/")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addtask 1 d/")]),_v(" (where x is an invalid patient ID or description is missing)"),_c('br'),_v("Expected: Similar to previous. Error details are shown in the status message explaining the issue with the command input.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Changing a priority level of a patient")]),_v(" "),_c('ol',[_c('li',[_v("Prerequisites: List all patients using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Patient should already exist in the list.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority 1 l/2")]),_c('br'),_v("Expected: Priority level 2 is assigned to the patient with ID 1. Details of the priority update are shown in the status message. Timestamp in the status bar is updated.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority 0 l/2")]),_c('br'),_v("Expected: No priority is assigned. Error details are shown in the status message indicating an invalid patient ID. Status bar remains the same.")]),_v(" "),_c('li',[_v("Other incorrect priority commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority x l/")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority 1 l/")]),_v(" (where x is an invalid patient ID or the priority level is missing or invalid)"),_c('br'),_v("Expected: Similar to previous. Error details are shown in the status message explaining the issue with the command input.")])])])])}
},function anonymous(
) {
